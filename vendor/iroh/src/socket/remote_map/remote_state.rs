            ...
            None => {
                ...
                match ret {
                    ...
                    | Some(Err(PathError::MaxPathIdReached)) => {
                        ...
                        // sth-core patch (n0-computer/iroh#4509): dedupe + bound the retry
                        // queue; without it the queue grows geometrically with the number of
                        // connections to the same remote and the process dies of OOM.
